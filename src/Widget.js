      ...
      return declare([BaseWidget, _WidgetsInTemplateMixin], {
          ...
          _onDrawEnd: function (graphic) {
              if (this.cbxBuffer.checked) {
                  var distance = this.queryBufferDistanceSelect.get("value");
                  var unit = this.queryBufferUnitsSelect.get("value");
                  var symbology = this.drawBox.polygonSymbol;
                  this.bufferTool.setParams(distance, unit, symbology, graphic);
              }
          },
          _initBufferUnitSelect: function () {
              ...
              array.forEach(bufferDistanceUnits, lang.hitch(this, function (unitInfo) {
                  ...
                  this.queryBufferUnitsSelect.addOption(option);
              }));
          },
          _initSelf: function () {
          ...
          _addBufferTool: function () {
              ...
              this.bufferTool = new Buffer(this.map, this.drawBox.drawLayer, params);
              ...
              on(this.cbxBuffer, "change", lang.hitch(this, function () {
                  ...
                  if (this.cbxBuffer.checked) {
                      if (this.drawBox.drawLayer.graphics[0]) {
                          this._onDrawEnd(this.drawBox.drawLayer.graphics[0]);
                      }
                  } else {
                      if (this.drawBox.drawLayer.graphics[1]) {
                          this.drawBox.drawLayer.remove(this.drawBox.drawLayer.graphics[1]);
                      }
                  }
              }))
